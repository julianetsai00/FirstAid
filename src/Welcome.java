	...
	public class Welcome extends JPanel implements MouseListener {// class header
	...
	private int counter;
		...
		public Welcome(JPanel cardPanel, CardLayout cardLayout) {// constructor
		...
		public void paintComponent(Graphics g) {// paintComponent header
			...
			Image img1 = Toolkit.getDefaultToolkit().getImage("welcome.png");
	...
	*/
		...
		public void mouseClicked(MouseEvent e) {
			...
			if (x1 < 786 && x1 > 627 && y1 < 780 && y1 > 708) {// if x and y are in
