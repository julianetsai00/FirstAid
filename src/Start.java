...
public class Start extends JPanel implements MouseListener {// class header
	...
	public Start(JPanel cardPanel, CardLayout cardLayout) {// constructor
	...
	public void paintComponent(Graphics g) {// paintComponent header
		...
		Image img1 = Toolkit.getDefaultToolkit().getImage("start.png");
...
*/
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (x1 < 569 && x1 > 227 && y1 < 640 && y1 > 537) {// if x and y are in
