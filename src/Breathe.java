...
public class Breathe extends JPanel implements MouseListener, AdjustmentListener  {//class header extends JPanel ActionListener and implement change listener
private JScrollBar scroll;//declare private scroll, and message, and value
...
public Breathe(JPanel cardPanel, CardLayout cardLayout) {// constructor
	this.cardPanel=cardPanel;
	this.cardLayout=cardLayout;


        
        up = Toolkit.getDefaultToolkit().getImage("scroll2.png");//initialize images
        down = Toolkit.getDefaultToolkit().getImage("scroll1.png");
        ...
        */
        ...
        scroll=new Jscroll(Jscroll.VERTICAL,0,100,0);//create scroll
        add(scroll,BorderLayout.EAST);//add scroll to south
        scroll.addChangeListener(this);//add change listener
        */
        
        scroll= new JScrollBar(JScrollBar.VERTICAL, 0, 30, 0, 100);
        scroll.setPreferredSize(new Dimension(20,400));
        
        this.addMouseListener(this);
        this.add(scroll);
        scroll.addAdjustmentListener((AdjustmentListener) this);//add change listener
        change=true;
        repaint();
...
scroll.setBounds(550, 270, 20, 400);
