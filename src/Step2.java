	...
	public class Step2 extends JPanel implements MouseListener {// class header
	...
	private int counter;
		...
		public Step2(JPanel cardPanel, CardLayout cardLayout) {// constructor
		...
		public void paintComponent(Graphics g) {// paintComponent header
			...
			Image img1 = Toolkit.getDefaultToolkit().getImage("step2.png");
