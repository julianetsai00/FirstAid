	...
	public class Step1 extends JPanel implements MouseListener {// class header
	...
	private int counter;
		...
		public Step1(JPanel cardPanel, CardLayout cardLayout) {// constructor
		...
		public void paintComponent(Graphics g) {// paintComponent header
			...
			Image img1 = Toolkit.getDefaultToolkit().getImage("step1.png");
